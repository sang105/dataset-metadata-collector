      ...
      <div style={{ padding: "18px 16px 14px", borderBottom: "1px solid #0D1B2E" }}>
        ...
        <div style={{ marginTop: 14 }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
            <span style={{ fontSize: 11, color: "#334155", textTransform: "uppercase", letterSpacing: "0.1em", fontFamily: "'DM Sans', sans-serif" }}>Overall Progress</span>
            <span style={{ fontSize: 11, color: overallPct === 100 ? "#10B981" : "#0EA5E9", fontFamily: "'DM Sans', sans-serif", fontWeight: 700 }}>{overallPct}%</span>
          </div>
      ...
      <div style={{ padding: "12px 16px", borderTop: "1px solid #0D1B2E" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <span style={{ fontSize: 12, color: "#334155", fontFamily: "'DM Sans', sans-serif" }}>
            {saveStatus === "saving" ? "Saving…" : saveStatus === "saved" ? "Draft saved locally" : lastSaved ? `Saved locally ${new Date(lastSaved).toLocaleTimeString()}` : "No draft saved"}
          </span>
        </div>
      </div>
    </aside>
